...
if ($mode==0) { 
	...
	for ($click=$orderplace;$click<=$orderplace+($x*$y)-1;$click++) { 
		...
		print "<td>"; 
		print $startdiv."<a href=\"".$baseurl."index.php?mode=2&method=3&type=".$loop."&name=".$class[$loop][$attnum+1]."\" onMouseover=\"window.status='choose ".$class[$loop][$attnum+1]."'; return true\"><img style=\"border-color: #8888FF\" src=\"".$baseurl."images/misc/thumb_".$class[$loop][0].".jpg\" alt=\"".$class[$loop][$attnum+1].", a"; 
